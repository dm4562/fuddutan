...
ActiveRecord::Schema.define(version: 20151019030329) do
  ...
  create_table "gt_users", force: :cascade do |t|
  ...
  add_index "gt_users", ["email"], name: "index_gt_users_on_email", unique: true
  add_index "gt_users", ["reset_password_token"], name: "index_gt_users_on_reset_password_token", unique: true
